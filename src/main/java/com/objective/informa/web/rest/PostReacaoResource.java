...
public class PostReacaoResource {
    ...
    public ResponseEntity<PostReacaoDTO> createPostReacao(@Valid @RequestBody PostReacaoDTO postReacaoDTO) throws URISyntaxException {
        ...
        PostReacaoDTO result = postReacaoService.save(postReacaoDTO);
        return ResponseEntity.created(new URI("/api/post-reacaos/" + result.getId()))
    ...
    public ResponseEntity<PostReacaoDTO> updatePostReacao(@Valid @RequestBody PostReacaoDTO postReacaoDTO) throws URISyntaxException {
    ...
    public ResponseEntity<Void> deletePostReacao(@PathVariable Long id) {
        log.debug("REST request to delete PostReacao : {}", id);
        postReacaoService.delete(id);
