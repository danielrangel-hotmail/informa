...
import com.objective.informa.security.jwt.JWTConfigurer;
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .headers()
                ...
                .and()
                .contentSecurityPolicy("img-src 'self' data: https://objective-informa-arquivos.s3.us-east-1.amazonaws.com;")
                .and()
                .contentSecurityPolicy("font-src 'self' data: https://fonts.googleapis.com https://fonts.gstatic.com")
        .and()
        ...
        .and()
            ...
            .antMatchers("/api/insistence-environment/**").permitAll()
