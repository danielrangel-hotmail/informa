...
export class NgxGalleryPreviewComponent implements OnInit, OnChanges, OnDestroy {
    ...
    open(index: number): void {
        ...
        this.keyDownListener = this.renderer.listenGlobal("window", "keydown", (e: any) => this.onKeyDown(e));
    }
