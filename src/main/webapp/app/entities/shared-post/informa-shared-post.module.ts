...
import {InformaMensagemModule} from 'app/entities/mensagem/mensagem.module';

@NgModule({
  imports: [InformaSharedModule, RouterModule, InformaMensagemModule, QuillModule.forRoot(), NgxGalleryModule, EmbedVideo, GravatarModule ],
