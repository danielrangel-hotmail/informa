...
public class PostResourceIT {
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getCriacao()).isEqualTo(DEFAULT_CRIACAO);
        assertThat(testPost.getUltimaEdicao()).isEqualTo(DEFAULT_ULTIMA_EDICAO);
        assertThat(testPost.getConteudo()).isEqualTo(DEFAULT_CONTEUDO);
        assertThat(testPost.getPublicacao()).isEqualTo(DEFAULT_PUBLICACAO);
    }
    ...
    public void getAllPosts() throws Exception {
        ...
        restPostMockMvc.perform(get("/api/posts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].publicacao").value(hasItem(sameInstant(DEFAULT_PUBLICACAO))));
    }
