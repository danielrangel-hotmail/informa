...
import { MensagemComponent } from 'app/entities/mensagem/mensagem.component';
...
describe('Component Tests', () => {
  describe('Mensagem Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mensagems && comp.mensagems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
