...
import { LinkExternoComponent } from 'app/entities/link-externo/link-externo.component';
...
describe('Component Tests', () => {
  describe('LinkExterno Management Component', () => {
    let comp: LinkExternoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LinkExternoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.linkExternos && comp.linkExternos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
